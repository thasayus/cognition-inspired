...
from neuspell import available_checkers, ElmosclstmChecker, BertChecker
...
checker.finetune(clean_file="full_degrade5_ground_a_train80.txt", corrupt_file="full_degrade5_input_a_train80.txt", data_dir="default", n_epochs=2)
pickle.dump(checker, open('BertChecker_layer2_full_degrade5_ground_a_train80.pkl', 'wb'))
